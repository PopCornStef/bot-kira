# [BOT]Kira - Unreal Tournament Server Query Discord Bot
...
This Discord bot is a modified copy of the original from Scott Adkin (https://github.com/scottadkin/Unreal-Tournament-Server-Query-Discord-Bot)
This copy was done under Scott Adkin authorization an adapted for {MOS} Team. 

# Version 01.00.01 (9th March 2021) for local use
- Adaptation for {MOS} UT99 team

# Version H_01.00.00 (9th March 2021) for HEROKU hosting
- Adaptation for {MOS} UT99 team
...
- Run the command **node app.js** to start the bot.
